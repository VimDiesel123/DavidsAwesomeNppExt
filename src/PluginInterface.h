...
// You should implement (or define an empty function body) those functions which
// are called by Notepad++ plugin manager
...
// This API return always true now, since Notepad++ isn't compiled in ANSI mode
// anymore
